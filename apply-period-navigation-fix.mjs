...
const backup = indexFile + '.period-5.3.18-backup';
...
const injection = '\n  <!-- ELISEI 5.3.18 PERIOD NAVIGATION FIX -->\n' +
  '  <link rel="stylesheet" href="/elisei-period-smart.css?v=5.3.18">\n' +
  '  <script src="/elisei-period-smart.js?v=5.3.18"></script>\n';
...
fs.writeFileSync(path.join(projectRoot, 'ELISEI_BUILD_5_3_17_SMART_PERIOD.txt'), [
  ...
  'NAVIGATION: soft refresh without redirect to Main',
...
console.log('ELISEI 5.3.18 установлен: выбор периода больше не сбрасывает текущий раздел.');
