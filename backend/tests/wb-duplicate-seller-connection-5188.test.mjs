...
assert.ok(server.includes('PARTITION BY user_id,marketplace,seller_id'),'duplicate guard must rank connections inside the same user/marketplace/seller cabinet')
