...
assert.equal(backendPackage.version, '2.27.2')
assert.equal(frontendPackage.version, '5.15.2')
...
console.log('ELISEI 5.15.2 preserves user-initiated callcheck regression: OK')
