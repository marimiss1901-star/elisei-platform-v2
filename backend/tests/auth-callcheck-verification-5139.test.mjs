...
assert.equal(backendPackage.version, '2.27.3')
assert.equal(frontendPackage.version, '5.15.3')
...
console.log('ELISEI 5.15.3 preserves user-initiated callcheck regression: OK')
