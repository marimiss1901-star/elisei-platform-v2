...
assert.equal(backendPackage.version, '2.27.0')
assert.equal(frontendPackage.version, '5.15.0')
...
console.log('ELISEI 5.15.0 preserves user-initiated callcheck regression: OK')
