...
assert.equal(backendPackage.version, '2.27.1')
assert.equal(frontendPackage.version, '5.15.1')
...
console.log('ELISEI 5.15.1 preserves user-initiated callcheck regression: OK')
