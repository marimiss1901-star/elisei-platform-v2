...
assert.ok(server.includes("version: '2.22.4'"),'backend health must report 2.22.4')
assert.ok(server.includes('ELISEI/2.22.4'),'WB User-Agent must report backend 2.22.4')
