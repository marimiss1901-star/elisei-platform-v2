...
assert.ok(server.includes("version: '2.25.2'"),'backend health must report 2.22.4')
assert.ok(server.includes('ELISEI/2.25.2'),'WB User-Agent must report backend 2.22.4')
