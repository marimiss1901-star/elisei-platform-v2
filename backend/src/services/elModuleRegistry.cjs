...
const MODULES = Object.freeze({
  diagnostics: {
    ...
    internal: true,
    keywords: ['что изменилось', 'что поменялось', 'почему упал', 'почему упала', 'почему просел', 'почему просела', 'почему снизил', 'почему снизилась', 'почему стало хуже', 'важнее всего', 'главное действие', 'одно главное действие', 'выбрать одно действие', 'выбери одно действие', 'помоги выбрать', 'что делать по кабинету', 'что делать', 'вытянуть в плюс', 'вывести в плюс', 'кабинет в минусе', 'антикризис', 'разбери причины', 'найди причину'],
    paths: [],
  },
  overview: {
