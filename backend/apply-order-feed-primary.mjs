...
if(!source.includes("from './wb/order-feed.js'")){
  replaceOnce(
    ...
    "import { ORDER_FEED_ENDPOINT, ORDER_FEED_PAGE_LIMIT, ORDER_FEED_PRIMARY_VERSION, buildOrderFeedRequest, normalizeOrderFeedOrder, orderFeedSalesRows, mergeOrderFeedOrders, mergeOrderFeedSales, orderFeedRateLimitSeconds } from './wb/order-feed.js'\n\nconst { buildDecisionAnalysis, previousEqualPeriod } = elDecisionEngine",
    'order feed import')
}
